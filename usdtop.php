...
function curl($url, $post = 0, $httpheader = 0, $proxy = 0)
{
    ...
    curl_setopt($ch, CURLOPT_COOKIEFILE, "usdtop.txt");
    curl_setopt($ch, CURLOPT_COOKIEJAR, "usdtop.txt");
...
if ($IP != "") {
    ...
    $login  = login($email, $token, array_merge(head(), array("Referer: https://usdtpayu.top/")));
    sleep(5);
        ...
        for ($i = 0; $i < 500; $i++) {
            ...
            if ($check == "404") {
                ...
                if ($sttsBal == "Empty") {
                    ...
                    echo $check2;
                    echo $WhiteTebal . "[23] Coin " . $YellowTebal . "USDT PAYU TOP " . $RedTebal . "Kosong. " . $WhiteTebal . "Tunggu Besok Lagi !!!\n";
                    sleep(2);
                    system('php xrptop.php');
                } else {
                    ...
                    if ($alert == "danger") {
                        ...
                        $balance = explode(' USDT</p>', explode('<p class="lh-1 mb-1 font-weight-bold">', $currency)[1])[0];
                        ...
                        if ($aft == "") {
                            ...
                            sleep(2);
                            echo $WhiteTebal . "Telah dikirim = " . $GreenTebal . "" . $balance . " USDT\n";
                            sleep(2);
