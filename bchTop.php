...
function curl($url, $post = 0, $httpheader = 0, $proxy = 0)
{
    ...
    curl_setopt($ch, CURLOPT_COOKIEFILE, "bchTop.txt");
    curl_setopt($ch, CURLOPT_COOKIEJAR, "bchTop.txt");
    ...
    while (true) {
        for ($i = 0; $i < 500; $i++) {
            ...
            if ($check == "404") {
                ...
                if ($sttsBal == "Empty") {
                    echo $check2;
                    echo $WhiteTebal . "[3] Coin " . $YellowTebal . "BCH PAYU TOP " . $RedTebal . "Kosong. " . $WhiteTebal . "Tunggu Besok Lagi !!!\n";
                    sleep(2);
                    system('php bnbtop.php');
                } else {
