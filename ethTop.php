...
function curl($url, $post = 0, $httpheader = 0, $proxy = 0)
{
    ...
    curl_setopt($ch, CURLOPT_COOKIEFILE, "ethTop.txt");
    curl_setopt($ch, CURLOPT_COOKIEJAR, "ethTop.txt");
...
if ($IP != "") {
    ...
    $login  = login($email, $token, array_merge(head(), array("Referer: https://ethpayu.top/")));
    sleep(5);
        ...
        for ($i = 0; $i < 500; $i++) {
            ...
            if ($check == "404") {
                ...
                if ($sttsBal == "Empty") {
                    ...
                    echo $check2;
                    echo $WhiteTebal . "[11] Coin " . $YellowTebal . "ETH PAYU TOP " . $RedTebal . "Kosong. " . $WhiteTebal . "Tunggu Besok Lagi !!!\n";
                    sleep(2);
                    system('php feytop.php');
                } else {
